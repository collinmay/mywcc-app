...
public class CalendarPage extends AppCompatActivity
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if(id == R.id.nav_home_page){
            Intent intent = new Intent(CalendarPage.this, HomePageActivity.class);

            startActivity(intent);
        } else if (id == R.id.nav_student_profile) {
            Intent intent = new Intent(CalendarPage.this,StudentProfilePage.class);

            startActivity(intent);
        } else if (id == R.id.nav_WCC_map) {
            Intent intent = new Intent(CalendarPage.this,MapCollegePage.class);
